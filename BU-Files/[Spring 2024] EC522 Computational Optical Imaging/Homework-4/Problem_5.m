...
saveas(gcf, 'problem_5_1.png');

% Calculate PSNR between deblurred_image1 and original f
psnr_deblurred_image1 = psnr(uint8(f_est_g1), uint8(ori_f));

% Calculate PSNR between deblurred_image2 and original f
psnr_deblurred_image2 = psnr(uint8(f_est_g2), uint8(ori_f));
...
% Save the figure with reduced margin
saveas(gcf, 'problem_5_2.png');

% Calculate PSNR between deblurred_image1 and original f
psnr_deblurred_image1 = psnr(uint8(abs(f_rec1_tikhonov)), uint8(ori_f));

% Calculate PSNR between deblurred_image2 and original f
psnr_deblurred_image2 = psnr(uint8(abs(f_rec2_tikhonov)), uint8(ori_f));
