...
Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(16),i.e(4001)]).then(i.bind(null,"PrO8")).then(({default:t})=>{const i=document.createElement("div")
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([i.e(7),i.e(4044)]).then(i.bind(null,"dIBj")).then(({default:i})=>{const a=new i(t.ed)
e.equationCB(a)})})
document.addEventListener("tinyRCE/initLinks",({detail:t})=>{B.renderDialog(t.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(7),i.e(8),i.e(9),i.e(25),i.e(81),i.e(75),i.e(86),i.e(4002)]).then(i.bind(null,"FfTR")).then(({default:i})=>{const a=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(a)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(4120).then(i.bind(null,"IOhY")).then(({default:i})=>{i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{V.init(t.detail.ed,t.detail.url,q["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(44),i.e(4121)]).then(i.bind(null,"lUrZ")).then(({default:i})=>{i.insertEditor(t.detail.ed)
...
//# sourceMappingURL=21-c-89c13fe2cd.js.map