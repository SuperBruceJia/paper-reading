window.jwplayer = function(e) {
	...
	var i, o;
	i = [n(9), n(1), n(34), n(35), n(23), n(36), n(13), n(61), n(38), n(64), n(149), n(148), n(65)], o = function(e, t, n, i, o, r, a, s, l, u, c, d, p) {
		var f = {};
		...
		}, f.indexOf = t.indexOf, f.noop = function() {}, f.seconds = e.seconds, f.prefix = e.prefix, f.suffix = e.suffix, t.extend(f, r, a, l, n, s, i, o, u, c, d, p), f
	}.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function(e, t, n) {
	var i, o;
	i = [n(1)], o = function(e) {
	...
	i = [n(9), n(172)], o = function(e, t) {
		...
		var o = function(e, n, i) {
				...
				if ("object" == typeof n) {
					var a;
					for (a in n) if (Object.prototype.hasOwnProperty.call(n, a)) break;
					if (!a) return;
	...
	var i, o;
	i = [], o = function() {
		return "7.10.1+commercial_v7-10-1.166.commercial.2ad595.jwplayer.821de3.freewheel.54b0c5.googima.084546.vast.e8d27a.analytics.61e894.plugin-gapro.7e936b.plugin-related.63808e.plugin-sharing.b34735.vr-plugin.d532d3.hls.js."
	}.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function(e, t, n) {
	var i, o;
	...
	var i, o;
	i = [n(2), n(42), n(129), n(1), n(3), n(147), n(4), n(5)], o = function(e, t, n, i, o, r, a, s) {
		var l = function() {
				function r(e, t) {
					var n = i.extend({}, t, {
						type: e
				...
				this.mediaController = i.extend({}, o), this.mediaModel = new u, n.model(this), this.set("mediaModel", this.mediaModel), this.setup = function(e) {
					...
					return this.get("autostart") && !this.get("sdkplatform") && (l() && (e.isSafari() || e.isChrome() || e.isFacebook()) || e.isAndroid() && e.isChrome()) && (!this.get("advertising") || this.get("advertising").autoplayadsmuted)
				}
			},
	...
	var i, o;
	i = [n(9), n(1), n(145)], o = function(e, t, n) {
		var i = {};
	...
	var i, o;
	i = [n(2), n(170), n(4), n(183), n(1)], o = function(e, t, n, i, o) {
		var r = function(r, a) {
				var s = new t(r, a),
					l = s.setup;
	...
	var i, o;
	i = [n(4), n(5), n(3), n(2), n(66), n(1), n(177), n(116), n(117), n(119), n(26)], o = function(e, t, n, i, o, r, a, s, l, u, c) {
		var d = function(d, p) {
				var f, h = this;
	...
	var i, o;
	i = [n(178), n(3), n(1), n(4)], o = function(e, t, n, i) {
		...
		var i = function(i, o) {
				...
				function s(e) {
					...
					if (!o.get("renderCaptionsNatively") && i) {
						var r, s;
						for (r = 0; r < i; r++) s = n[r], l(s.kind) && !m[s._id] && (p(s), t.loadFile(s, u.bind(null, s), c))
					}
					var d = f();
	...
	var i, o;
	i = [n(120), n(126), n(1), n(122), n(123), n(29), n(131), n(52), n(51), n(2), n(76), n(3), n(30), n(5), n(4), n(162), n(125)], o = function(e, t, n, i, o, r, a, s, l, u, c, d, p, f, h, g, w) {
		function m(e) {
			return function() {
		...
		return j.prototype = {
			...
			setup: function(r, g) {
				...
				function j() {
					pe = null, ce.on("all", m, je), we.set("playOnViewable", we.autoStartOnMobile() || "viewable" === we.get("autostart")), _(), L(), we.on("change:activeTab", _), we.on("change:fullscreen", _), we.on("change:intersectionRatio", _), we.on("change:visibility", P);
					var e = g.getPlugin("related");
					e && e.on("nextUp", we.setNextUp, we), ce.once(h.JWPLAYER_RESIZE, y), ce.init()
				}
				function y() {
				...
				function k() {
					...
					return n.isUndefined(e) && (e = C(ce.element())), e
				}
				function C(e) {
					...
					for (var o = e.getBoundingClientRect(), r = o, a = e.parentNode, s = !1; !s;) {
						var l = null;
						if (a && 1 === a.nodeType ? "visible" !== window.getComputedStyle(a).overflow && (l = u.bounds(a)) : (s = !0, l = i), l && (r = A(l, r), !r)) return 0;
						a = a.parentNode
					}
				...
				function T() {
					...
					u.isMobile() || e !== !0 ? P(we, we.get("visibility")) : Y()
				}
				function P() {
					L();
					var e = we.get("viewable");
					we.get("playOnViewable") && (e ? Y() : u.isMobile() && je.pause({
						reason: "autostart"
					}))
				}
				function R(e) {
				...
				function D(e) {
					if (e && we.set("playReason", e.reason), we.get("state") !== f.ERROR) {
						...
						if (J()) {
							...
							i = u.tryCatch(function() {
								we.loadVideo()
							})
						} else we.get("state") === f.PAUSED && (i = u.tryCatch(function() {
							we.playVideo()
						}));
						i instanceof u.Error && (je.triggerError(i), fe = null)
					}
				}
				function Y() {
					D({
				...
				function W(e) {
					...
					return n instanceof u.Error ? (je.triggerError(n), !1) : (t && (ve = !0), me && (he = !0), !0)
				}
				function F(e) {
					...
					case f.PLAYING:
					case f.BUFFERING:
						var i = u.tryCatch(function() {
							ye().pause()
						}, this);
						if (i instanceof u.Error) return void je.triggerError(i);
						break;
					default:
						me && (he = !0)
					}
				...
				function B(e, t) {
					we.get("state") !== f.ERROR && (we.get("scrubbing") || we.get("state") === f.PLAYING || D(t), ye().seek(e))
				}
				function V(e, t) {
					W(!0), we.get("state") === f.ERROR && we.set("state", f.IDLE), z(e), D(t)
				}
				function U(e) {
					var t = s(e);
				...
				function se() {
					...
					return e instanceof u.Error ? void u.log("Error calling _attachMedia", e) : void("function" == typeof fe && fe())
				}
				function le(e) {
				...
				var ce, de, pe, fe, he, ge, we = this._model,
					me = !1,
					ve = !1,
					je = this,
					ye = function() {
				...
				var xe = new e(r, be),
					Ee = [];
				we.setup(xe, be), ce = this._view = new c(g, we), pe = new i(g, we, ce, U), pe.on(h.JWPLAYER_READY, j, this), pe.on(h.JWPLAYER_SETUP_ERROR, this.setupError, this), we.mediaController.on("all", m, this), we.mediaController.on(h.JWPLAYER_MEDIA_COMPLETE, function() {
					n.defer(q)
				...
				}, this.resize = ce.resize, this.getSafeRegion = ce.getSafeRegion, this.setCues = ce.addCues, this.setCaptions = ce.setCaptions, this.next = ue, this.addButton = function(e, t, i, o, r) {
					var a = {
						img: e,
						tooltip: t,
						callback: i,
					...
					this.stop(), x(), this.showView(this.originalContainer), ce && ce.destroy(), we && we.destroy(), pe && (pe.destroy(), pe = null)
				}, this.isBeforePlay = this.checkBeforePlay, this.isBeforeComplete = function() {
					return we.checkComplete()
				}, this.createInstream = function() {
					return this.instreamDestroy(), this._instreamAdapter = new t(this, we, ce), this._instreamAdapter
		...
		var l = {
			...
			u = function(e, r, u) {
				...
				this.loadItem = function(e, i) {
					...
					var u = r.getProviders(),
						c = j === t ? "flash" : void 0,
						d = u.required(s, c);
					r.set("hideAdsControls", !1), u.load(d).then(function() {
						if (null !== y) {
					...
					if (this.off(), r.set("skipButton", !1), y) {
						u.clickHandler() && u.clickHandler().revertAlternateClickHandlers(), r.off(null, null, y), y.off(null, null, E), y.instreamDestroy(), u.destroyInstream(), y = null, e.attachMedia();
	...
	var i, o;
	i = [n(11), n(41), n(140), n(1), n(144)], o = function(e, t, i, o, r) {
		function a(e) {
	...
	i = [n(2), n(23), n(5), n(1)], o = function(e, t, i, o) {
		...
		return r = function(r) {
			function l() {
				...
				return e ? void(E = s.fontScale * k.fontSize / s.fontSize) : void r.once("change:containerHeight", l)
			}
			function u() {
				var e = r.get("containerHeight");
				if (e) {
					var t = Math.round(e * E);
					r.get("renderCaptionsNatively") ? d(r.get("id"), t) : a(j, {
						fontSize: t + "px"
					})
				}
			}
			function c(n, i, o) {
				if (i.backgroundColor && (t.css("#" + n + " .jw-text-track-display", i, n), t.css("#" + n + " .jw-video::-webkit-media-text-track-display", i, n)), Object.getOwnPropertyNames(o).length && (t.css("#" + n + " .jw-text-track-cue", o, n), t.css("#" + n + " .jw-video::cue", o, n)), u(), o.color && e.isSafari() && t.css("#" + n + " .jw-video::cue", "{color: " + o.color + " !important;}", n), o.backgroundColor) {
					var r = "{background-color: " + o.backgroundColor + " !important;}";
					t.css("#" + n + " .jw-video::-webkit-media-text-track-display-backdrop", r, n)
				}
			}
			function d(n, i) {
			...
			function p(e, n, i) {
				if (n.color && (e.color = t.hexToRgba(n.color, i)), n.back) {
					var o = n.backgroundColor,
						r = n.backgroundOpacity;
					o === s.backgroundColor && r === s.backgroundColor || (e.backgroundColor = t.hexToRgba(o, r))
			...
			function h(e) {
				r.get("renderCaptionsNatively") || (v = e, this.selectCues(w, v))
			}
			function g() {
			...
			var w, m, v, j, y, b, x, E, k = {};
			j = document.createElement("div"), j.className = "jw-captions jw-reset", this.show = function() {
				j.className = "jw-captions jw-captions-enabled jw-reset"
			}, this.hide = function() {
				j.className = "jw-captions jw-reset"
			}, this.populate = function(e) {
				if (!r.get("renderCaptionsNatively")) return m = [], w = e, e ? void this.selectCues(e, v) : (m = [], void this.renderCues())
			}, this.resize = function() {
				u(), this.renderCues(!0)
			}, this.renderCues = function(e) {
				e = !! e, x && x.WebVTT.processCues(window, m, j, e)
				...
				return e.length ? o.difference(e, m).length && (y.className = "jw-captions-window jw-reset jw-captions-window-active", m = e) : m = [], m
				...
				y = document.createElement("div"), b = document.createElement("span"), y.className = "jw-captions-window jw-reset", b.className = "jw-captions-text jw-reset", k = o.extend({}, s, n), E = s.fontScale, l(k.fontSize);
				var i = k.fontOpacity,
					u = k.windowOpacity,
					d = k.edgeStyle,
					h = {},
					g = {};
				p(g, k, i), k.windowColor && u && (h.backgroundColor = t.hexToRgba(k.windowColor, u)), f(d, g, i), k.back || null !== d || f("uniform", g), a(y, h), a(b, g), c(e, h, g, k.fontSize), y.appendChild(b), j.appendChild(y), this.populate(r.get("captionsTrack")), r.set("captions", k)
				...
				m = []
			}, this), r.mediaController.on("time seek", h, this), r.mediaController.on("subtitlesTrackData", function() {
				this.selectCues(w, v)
	...
	var i, o;
	i = [n(1), n(2), n(22), n(7), n(39), n(40), n(153), n(156)], o = function(e, t, n, i, o, r, a, s) {
		function l() {
			return {
				reason: "interaction"
			}
		...
		var u = r.extend({
			...
			c = o.extend({
				constructor: function(t, n) {
					this._model = t, this._api = n, this.timeTip = new u("jw-tooltip-time"), this.timeTip.setup(), this.cues = [], this.seekThrottled = e.throttle(this.performSeek, 400), this.mobileHoverDistance = 5, this._model.on("change:playlistItem", this.onPlaylistItem, this).on("change:position", this.onPosition, this).on("change:duration", this.onDuration, this).on("change:buffer", this.onBuffer, this), o.call(this, "jw-slider-time", "horizontal")
				},
				setup: function() {
				...
				showTimeTooltip: function(o) {
					...
					if (0 !== r) {
						...
						if ("touch" === i.getPointerType(o.sourceEvent) && (this.activeCue = e.reduce(this.cues, function(e, t) {
							...
							var p = !0;
							d = t.timeFormat(c, p), r < 0 && c > n.dvrSeekLimit && (d = "Live")
						}
						var f = this.timeTip;
						f.update(d), this.textLength !== d.length && (this.textLength = d.length, f.resetWidth()), this.showThumbnail(c), t.addClass(f.el, "jw-open");
						var h = f.getWidth(),
							g = s.width / 100,
							w = a - s.width,
							m = 0;
						h > w && (m = (h - w) / (200 * g));
						var v = 100 * Math.min(1 - m, Math.max(m, u)).toFixed(3);
						t.style(f.el, {
							left: v + "%"
						})
					}
		...
		return e.extend(c.prototype, a, s), c
	}.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function(e, t, n) {
	var i, o;
	...
	var i, o;
	i = [n(2), n(1), n(3), n(22), n(7), n(39), n(157), n(154), n(158), n(68)], o = function(e, t, n, i, o, r, a, s, l, u) {
		function c(e, t) {
		...
		return t.extend(g.prototype, n, {
			...
			build: function() {
				...
				this._isMobile || (n = new r("jw-slider-volume", "horizontal"), i = new l(this._model, "jw-icon-volume", v)), this._model.get("sdkplatform") || e.isIOS(8) || e.isIOS(9) || (s = u("jw-icon-volume", this._api.setMute, v));
				var y = u("jw-icon-next", this._api.next.bind(this), m);
				this._model.get("nextUpDisplay") && new o(y.element(), {
					...
					play: u("jw-icon-playback", this._api.play.bind(this, f()), w),
					rewind: u("jw-icon-rewind", this.rewind.bind(this), j),
					next: y,
	...
	i = [n(7), n(2), n(4), n(1), n(3), n(107)], o = function(e, t, n, i, o, r) {
		...
		return function(l) {
			function u() {
				...
				t.toggleClass(c, "below", n)
			}
			var c, d, p = new Image,
				f = i.extend({}, l.get("logo"));
			return i.extend(this, o), this.setup = function(o) {
				if (d = i.extend({}, s, f), d.hide = "true" === d.hide.toString(), c = t.createElement(r()), d.file) {
					d.hide && t.addClass(c, "jw-hide"), t.addClass(c, "jw-logo-" + (d.position || s.position)), l.set("logo", d), u(), l.on("change:dock", u), p.onload = function() {
						var e = {
				...
				l.off("change:dock", u), p.onload = null
			}, this
		}
	}.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function(e, t, n) {
	...
	var i, o;
	i = [n(2), n(4), n(3), n(22), n(143), n(5), n(151), n(152), n(167), n(165), n(164), n(161), n(163), n(159), n(166), n(184), n(169), n(155), n(1), n(110), n(150), n(68), n(160)], o = function(e, t, i, o, r, a, s, l, u, c, d, p, f, h, g, w, m, v, j, y, b, x, E) {
		var k = e.style,
			C = e.bounds,
			A = e.isMobile(),
		...
		return function(L, T) {
			...
			function O() {
				nt = !1, e.removeClass(ke, "jw-no-focus")
			}
			function N(e) {
				e.target && e.target.blur && e.target.blur()
			}
			function D() {
				nt = !0, e.addClass(ke, "jw-no-focus")
			}
			function Y() {
				nt || O(), Te || A || ce()
			}
			function W() {
				...
				if (Ze(Qe), n !== _e || i !== Le) {
					if (!n || !i) return void(_e && Le || J());
					_e = n, Le = i, T.set("containerWidth", n), T.set("containerHeight", i);
					var o = b(ke, n, i);
					ee(T.get("height")), F(o, T.get("audioMode"), T.get("controls")), ie(n, i), We.resize(), it.trigger(t.JWPLAYER_RESIZE, {
						width: n,
						height: i
					})
				}
			...
			function F(t, n, i) {
				var o = t < 2,
					...
					a = !n && i && r !== !1 && (r || o);
				e.toggleClass(ke, "jw-flag-small-player", o), e.toggleClass(ke, "jw-flag-audio-player", n), e.toggleClass(ke, "jw-flag-time-slider-above", a)
			}
			function J() {
				Ze(Qe), Qe = $e(W)
			}
			...
			function V(t, n) {
				e.replaceClass(ke, /jw-stretch-\S+/, "jw-stretch-" + n)
			}
			function U(e) {
				e && !A && (e.element().addEventListener("mousemove", G, !1), e.element().addEventListener("mouseout", q, !1))
			}
			function z() {
				var e = T.get("state");
				T.get("controls") && (e === a.IDLE || e === a.COMPLETE || Te && Te.get("state") === a.PAUSED) && L.play(P()), e === a.PAUSED ? de() : Ke ? le() : ce()
			}
			function H(e) {
			...
			function X(t, n) {
				n ? (Fe && Fe.destroy(), e.addClass(ke, "jw-flag-flash-blocked")) : (Fe && Fe.setup(T, ke, ke), e.removeClass(ke, "jw-flag-flash-blocked"))
			}
			function Q() {
				T.get("controls") && L.setFullscreen()
			}
			function $() {
				var n = ke.getElementsByClassName("jw-overlays")[0];
				n.addEventListener("mousemove", ue), Me = new l(T, Ae, {
					useHover: !0
				...
				}), Me.on("doubleClick", Q), Me.on("move", ue), Me.on("over", ue), Ce.appendChild(be()), Se = new p(T), Oe = new f(T), Oe.on(t.JWPLAYER_LOGO_CLICK, H);
				var i = document.createElement("div");
				i.className = "jw-controls-right jw-reset", i.appendChild(Se.element()), Oe.setup(i), Ce.appendChild(i), We = new s(T), We.setup(ke.id, T.get("captions")), Ce.parentNode.insertBefore(We.element(), Ne.element()), rt = T.get("height"), A && ("string" == typeof rt || rt >= qe) ? e.addClass(ke, "jw-flag-touch") : (Fe = new w, Fe.setup(T, ke, ke)), Pe = new h(L, T), Pe.on(t.JWPLAYER_USER_ACTION, ue), T.on("change:scrubbing", ye), T.autoStartOnMobile() && (Ye = x("jw-autostart-mute jw-off", oe, T.get("localization").volume), Ye.show(), Ce.appendChild(Ye.element()), Pe.renderVolume(!0, T.get("volume")), e.addClass(ke, "jw-flag-autostart"), T.set("autostartMuted", !0), T.on("change:autostartFailed", oe), T.on("change:autostartMuted", oe), T.on("change:mute", oe)), T.get("nextUpDisplay") && (De = new v(T, L, ke), De.setup(), Ce.appendChild(De.element())), Ce.appendChild(Pe.element()), ke.addEventListener("focus", Y), ke.addEventListener("blur", O), ke.addEventListener("keydown", S), ke.onmousedown = D, ke.onmouseup = N
			}
			function Z(t, n, i) {
				var o, r = ke.className;
				i = !! i, i && (r = r.replace(/\s*aspectMode/, ""), ke.className !== r && (ke.className = r), k(ke, {
					display: "block"
				}, i)), e.exists(t) && e.exists(n) && (T.set("width", t), T.set("height", n)), o = {
					width: t
				}, e.hasClass(ke, "jw-flag-aspect-mode") || (o.height = n), k(ke, o, !0), ee(n), ie(t, n)
			}
			function ee(e) {
				var t = te(e);
				Pe && (t || ve(Te || T)), T.set("audioMode", t)
			}
			function te(e) {
				if (T.get("aspectratio")) return !1;
				if (j.isString(e) && e.indexOf("%") > -1) return !1;
				var t = 1 * e || null;
				return t = j.isNumber(t) ? t : T.get("containerHeight"), !! t && ne(t)
			}
			function ne(e) {
				return e && e <= qe
			}
			function ie(e, t) {
				if (!e || isNaN(Number(e))) {
					if (!Ae) return;
					e = T.get("containerWidth") || Ae.clientWidth
				}
				if (!t || isNaN(Number(t))) {
					if (!Ae) return;
					t = T.get("containerHeight") || Ae.clientHeight
				}
				Re && Re.resize(e, t, T.get("stretching"));
				var n = T.getVideo();
				if (n) {
					var i = n.resize(e, t, T.get("stretching"));
					i && (clearTimeout(Xe), Xe = setTimeout(ie, 250))
				}
			}
			function oe() {
				var t = !T.get("autostartFailed"),
					n = T.get("mute");
				t ? n = !1 : T.set("playOnViewable", !1), T.off("change:autostartFailed", oe), T.off("change:mute", oe), T.off("change:autostartMuted", oe), T.set("autostartFailed", void 0), T.set("autostartMuted", void 0), L.setMute(n), Pe.renderVolume(n, T.get("volume")), Ye.hide(), e.removeClass(ke, "jw-flag-autostart")
			}
			function re() {
				if (tt) {
				...
				return Te ? Te.getVideo().getFullScreen() : T.getVideo().getFullScreen()
			}
			function ae(e) {
				var t = T.get("fullscreen"),
					n = void 0 !== e.jwstate ? e.jwstate : re();
				t !== n && T.set("fullscreen", n), J(), clearTimeout(Xe), Xe = setTimeout(ie, 200)
			}
			function se(t, n) {
				n ? (e.addClass(t, "jw-flag-fullscreen"), k(document.body, {
					"overflow-y": "hidden"
				}), ce()) : (e.removeClass(t, "jw-flag-fullscreen"), k(document.body, {
					"overflow-y": ""
				})), ie(), J()
			}
			function le() {
				Ke = !1, clearTimeout(He), Pe.hideComponents(), e.addClass(ke, "jw-flag-user-inactive"), We.renderCues(!0)
			}
			function ue() {
				ce()
			}
			function ce(t) {
				Ke || (e.removeClass(ke, "jw-flag-user-inactive"), We.renderCues(!0)), Ke = !0, clearTimeout(He), He = setTimeout(le, t || Ge)
			}
			function de() {
				Te || T.get("castActive") || T.mediaModel && "audio" === T.mediaModel.get("mediaType") || (e.toggleClass(ke, "jw-flag-controls-hidden"), We.renderCues(!0))
			}
			function pe() {
				L.setFullscreen(!1)
			}
			function fe() {
				Ie && Ie.setState(T.get("state")), he(T, T.mediaModel.get("mediaType")), T.mediaModel.on("change:mediaType", he, this)
			}
			function he(t, n) {
				var i = "audio" === n,
					o = T.getVideo(),
					r = o && 0 === o.getName().name.indexOf("flash");
				e.toggleClass(ke, "jw-flag-media-audio", i), i && !r ? ke.insertBefore(Re.el, Ae) : ke.insertBefore(Re.el, We.element())
			}
			function ge(t, n) {
				var i = t.get("minDvrWindow"),
					o = e.streamType(n, i),
					r = "LIVE" === o;
				t.set("streamType", o), e.toggleClass(ke, "jw-flag-live", r), it.setAltText(r ? t.get("localization").liveBroadcast : "")
			}
			function we(e, t) {
				return t ? void(t.name ? Ne.updateText(t.name, t.message) : Ne.updateText(t.message, "")) : void Ne.playlistItem(e, e.get("playlistItem"))
			}
			function me() {
				e.replaceClass(ke, /jw-state-\S+/, "jw-state-" + Je)
			}
			function ve(t) {
				T.get("viewSetup") && (Je = t.get("state"), clearTimeout(et), Je === a.PLAYING ? je(t, Je) : et = $e(function() {
					je(t, Je)
				}), Je !== a.PAUSED && e.hasClass(ke, "jw-flag-controls-hidden") && e.removeClass(ke, "jw-flag-controls-hidden"))
			}
			function je(t, n) {
				switch (e.toggleClass(ke, "jw-flag-dragging", t.get("scrubbing")), me(), n) {
				case a.PLAYING:
					ie()
				}
			}
			...
			var ke, Ce, Ae, _e, Le, Te, Pe, Re, Me, Ie, Se, Oe, Ne, De, Ye, We, Fe, Je, Be, Ve, Ue, ze, He = -1,
				Ge = A ? 4e3 : 2e3,
				qe = 44,
				Ke = !1,
				Xe = -1,
			...
			}, Ze = window.cancelAnimationFrame || window.clearTimeout, et = -1, tt = !1, nt = !1, it = j.extend(this, i);
			window.webpackJsonpjwplayer && n(115), this.model = T, this.api = L, ke = e.createElement(y({
				id: T.get("id")
			})), e.isIE() && e.addClass(ke, "jw-ie");
			var ot = T.get("width"),
				rt = T.get("height");
			k(ke, {
				width: ot.toString().indexOf("%") > 0 ? ot : ot + "px",
				height: rt.toString().indexOf("%") > 0 ? rt : rt + "px"
			}), Ve = ke.requestFullscreen || ke.webkitRequestFullscreen || ke.webkitRequestFullScreen || ke.mozRequestFullScreen || ke.msRequestFullscreen, Ue = document.exitFullscreen || document.webkitExitFullscreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen, tt = Ve && Ue, this.onChangeSkin = function(t, n) {
				e.replaceClass(ke, /jw-skin-\S+/, n ? "jw-skin-" + n : "")
				...
				this.handleColorOverrides(), T.get("skin-loading") === !0 && (e.addClass(ke, "jw-flag-skin-loading"), T.once("change:skin-loading", function() {
					e.removeClass(ke, "jw-flag-skin-loading")
				})), T.on("change:skin", this.onChangeSkin, this), this.onChangeSkin(T, T.get("skin")), Ae = ke.querySelector(".jw-media"), Ce = ke.querySelector(".jw-controls");
				var t = ke.querySelector(".jw-preview");
				Re = new g(T), Re.setup(t);
				var n = ke.querySelector(".jw-title");
				Ne = new m(T), Ne.setup(n), $(), T.set("mediaContainer", Ae), T.mediaController.on("fullscreenchange", ae);
				for (var i = _.length; i--;) document.addEventListener(_[i], ae, !1);
				window.removeEventListener("resize", J), window.addEventListener("resize", J, !1), A && (window.removeEventListener("orientationchange", J), window.addEventListener("orientationchange", J, !1)), T.on("change:controls", at), at(T, T.get("controls")), T.on("change:flashBlocked", X), X(T, T.get("flashBlocked")), L.onPlaylistComplete(pe), L.onPlaylistItem(fe), T.get("stretching") && V(T, T.get("stretching")), T.on("change:state", ve), T.on("change:duration", ge, this), T.on("change:stretching", V), T.on("change:fullscreen", st), T.on("change:errorEvent", we), T.on("change:hideAdsControls", function(t, n) {
					e.toggleClass(ke, "jw-flag-ads-hide-controls", n)
				}), U(Pe), U(Oe);
				var o = T.get("aspectratio");
				if (o) {
					e.addClass(ke, "jw-flag-aspect-mode");
					var a = ke.querySelector(".jw-aspect");
					k(a, {
						paddingTop: o
					})
				}
				T.set("iFrame", e.isIframe()), T.set("activeTab", r()), document.addEventListener("visibilitychange", Ee, !1), document.addEventListener("webkitvisibilitychange", Ee, !1), T.set("viewSetup", !0)
			}, this.init = function() {
				Z(T.get("width"), T.get("height")), ve(Te || T), _e = 0, Le = 0, W(), ce()
			};
			var at = function(t, n) {
					n && ve(Te || T);
					var i = b(ke, _e, Le);
					F(i, T.get("audioMode"), n), e.toggleClass(ke, "jw-flag-controls-disabled", !n)
				},
				st = function(t, n) {
					var i = T.getVideo();
					n && T.get("autostartMuted") && oe(), tt ? (n ? Ve.apply(ke) : Ue.apply(document), se(ke, n)) : e.isIE() ? se(ke, n) : (Te && Te.getVideo() && Te.getVideo().setFullscreen(n), i.setFullscreen(n)), i && 0 === i.getName().name.indexOf("flash") && i.setFullscreen(n)
				};
			this.resize = function(e, t) {
				var n = !0;
				Z(e, t, n), W()
			}, this.resizeMedia = ie, this.reset = function() {
				document.contains(ke) && ke.parentNode.replaceChild(Be, ke), e.emptyElement(ke)
			}, this.setupInstream = function(t) {
				this.instreamModel = Te = t, Te.on("change:controls", at, this), Te.on("change:state", ve, this), e.addClass(ke, "jw-flag-ads"), ce()
			}, this.setAltText = function(e) {
				Pe.setAltText(e)
			}, this.destroyInstream = function() {
				if (Te && (Te.off(null, null, this), Te = null), this.setAltText(""), e.removeClass(ke, ["jw-flag-ads", "jw-flag-ads-hide-controls"]), T.set("hideAdsControls", !1), T.getVideo) {
					var t = T.getVideo();
					t.setContainer(Ae)
				}
				ge(T, T.get("duration")), Me.revertAlternateClickHandlers()
				...
				if (i) {
					var o = T.get("dock");
					o && o.length && (n.y = Se.element().clientHeight, n.height -= n.y), t = t || !e.exists(t), t && (n.height -= Pe.element().clientHeight)
				}
				return n
			}, this.setCaptions = function(e) {
				We.clear(), We.setup(T.get("id"), e), We.resize()
			}, this.destroy = function() {
				this.off(), clearTimeout(et), clearTimeout(Xe), clearTimeout(He), window.removeEventListener("resize", J), window.removeEventListener("orientationchange", J), document.removeEventListener("visibilitychange", Ee);
				for (var t = _.length; t--;) document.removeEventListener(_[t], ae, !1);
				T.mediaController && T.mediaController.off("fullscreenchange", ae), ke.removeEventListener("keydown", S, !1), Fe && Fe.destroy(), Ie && (T.off("change:state", Ie.statusDelegate), Ie.destroy(), Ie = null), Te && this.destroyInstream(), Oe && Oe.destroy(), e.clearCss(T.get("id"))
			}
		}
	}.apply(t, i), !(void 0 !== o && (e.exports = o))
}, , function(e, t, n) {
	...
	var i, o;
	i = [n(70), n(1), n(26), n(2), n(9), n(7), n(74), n(14), n(75), n(67), n(4), n(5), n(52), n(33), n(50), n(21)], o = function(e, t, n, i, o, r, a, s, l, u, c, d, p, f, h, g) {
		var w = {};
	...
	var i, o;
	i = [n(124), n(15), n(182), n(27), n(2), n(1)], o = function(e, t, i, o, r, a) {
		...
		return e.prototype.setup = function(e, r) {
			...
			function u() {
				var e = p.getVideo();
				l() ? (o.containsDrm(p) || c.apply(this), d.apply(this)) : e && e.video && (e.video.webkitWirelessVideoPlaybackDisabled = !0)
			}
			function c() {
	...
	var i, o;
	i = [n(132), n(173), n(1)], o = function(e, t, n) {
		var i = window,
			o = n.extend(e, t);
